...
the main aim of singleton pattern is making sure of only one instance of a class's exist.
Because if might need only one instance of a class in the whole application, and we use Singleton Pattern in such a case.
